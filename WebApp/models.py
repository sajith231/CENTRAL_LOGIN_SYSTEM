...
class WebControl(models.Model):
    project = models.ForeignKey(WebProject, on_delete=models.CASCADE, related_name='controls')
...
class LoginLog(models.Model):
    ...
    control = models.ForeignKey(WebControl, on_delete=models.CASCADE, related_name='login_logs')
    client_id = models.CharField(max_length=200)
